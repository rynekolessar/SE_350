...
class PostorderToString implements ExprVisitor<StringBuffer> {
  StringBuffer b = new StringBuffer();
  public StringBuffer visitConst(int c) {
    b.append (c + " ");
    return b;
  }
  public StringBuffer visitBinOp(Expr l, Op op, Expr r) {
    l.accept(this); r.accept(this); b.append (op + " ");
    return b;
  }
}

class PreOrderToString implements ExprVisitor<StringBuffer> {
  StringBuffer b = new StringBuffer();
  public StringBuffer visitConst(int c) {
    b.append (c + " ");
    return b;
...
class InOrderToString implements ExprVisitor<StringBuffer> {
  StringBuffer b = new StringBuffer();
  public StringBuffer visitConst(int c) {
    b.append (c + " ");
    return b;
