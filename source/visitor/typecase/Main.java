...
class PostorderPrint {
  ...
  static private StringBuffer b = new StringBuffer();
  static private StringBuffer runConst(int c) {
    b.append(c + " ");
    return b;
  }
  static private StringBuffer runBinOp(Expr l, Op op, Expr r) {
    run(l); run(r); b.append(op + " ");
    return b;
  }
  static public StringBuffer run(Expr e) {
