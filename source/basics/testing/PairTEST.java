...
public class PairTEST extends TestCase {
	...
	/**
	 * Constructor should throw IllegalArgumentException if either argument is null.
	 */
	...
	/**
	 * first() and second() should return references to the objects given to the
	 * constructor.
	 */
	...
	/**
	 * Here is a weaker version of the above test; this version allows Pair() to
	 * clone its arguments.
	 */
