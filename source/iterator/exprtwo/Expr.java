...
class PreorderIterator implements Iterator {
  ...
  public Object next() {
    if (hasNext())
      return ((AbsExpr)(_s.pop())).acceptPreOrder(this);
...
class PostorderIterator implements Iterator {
  ...
  public Object next() {
    if (hasNext())
      return ((AbsExpr)(_s.pop())).acceptPostOrder(this);
    throw new NoSuchElementException();
  }
  public void remove() {
    throw new UnsupportedOperationException();
...
class BreadthIterator implements Iterator {
  private Set _v = new HashSet();
  private List _l = new LinkedList();
  public boolean hasNext() {
    return ! _l.isEmpty();
  }
  boolean visited(AbsExpr e) {
